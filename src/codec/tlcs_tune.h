...
static inline float tune_celp_harm_str(void)    { static float v=-999; if(v<-900) v=tune_get_("TUNE_CELP_HARM_STR",    0.50f); return v; }
static inline float tune_celp_pf_num(void)      { static float v=-999; if(v<-900) v=tune_get_("TUNE_CELP_PF_NUM",      0.93f); return v; }
static inline float tune_celp_pf_den(void)      { static float v=-999; if(v<-900) v=tune_get_("TUNE_CELP_PF_DEN",      0.97f); return v; }
static inline float tune_celp_pf_tilt(void)     { static float v=-999; if(v<-900) v=tune_get_("TUNE_CELP_PF_TILT",     0.15f); return v; }
static inline float tune_celp_nf_voiced(void)   { static float v=-999; if(v<-900) v=tune_get_("TUNE_CELP_NF_VOICED",   0.20f); return v; }
static inline float tune_celp_nf_unvoiced(void) { static float v=-999; if(v<-900) v=tune_get_("TUNE_CELP_NF_UNVOICED", 0.50f); return v; }
