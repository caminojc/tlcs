...
/* ── Pitch sharpening ──────────────────────────────────── */
#define TLCS_PITCH_SHARPENING_COEF   0.81f

/* ── Shaped noise fill (decoder) ──────────────────────── */
#define TLCS_NOISE_V_GAIN    0.55f
#define TLCS_NOISE_UV_GAIN   0.58f
